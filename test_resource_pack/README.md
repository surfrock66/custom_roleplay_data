...
- The "Supported Formats" selector in pack.mcmeta doesn't work before 1.20.2 and your resource packs will show up as incompatible, and worst of all even if you bypass the warning, custom models load inconsistently.  By directly targeting the pack format, it will work.
