...
tellraw @s [{"text":"Updated to support strings in v61+ by surfrock66", "color": "aqua", "clickEvent": {"action": "open_url", "value": "https://www.teh3l3m3nts.com"}}]
tellraw @s [{"text":"Min required levels: ","color":"aqua","hoverEvent":{"action":"show_text","contents":[{"text":"Sets the number of minimum levels required to set CustomModelData (Using Numbers/Floats Only).\nSet to 0 to disable level requirement.","color":"yellow"}]},"clickEvent":{"action":"suggest_command","value":"/scoreboard players set #min_level crd_xp_dummy <level>"}},{"score":{"name":"#min_level","objective":"crd_xp_dummy"},"color":"green"}]
